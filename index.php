            ...
            <div class="row">
                <div class="col-6">
                    <p>ForkScore è la nuova piattaforma digitale dedicata agli amanti del buon cibo e delle esperienze gastronomiche autentiche. Progettata per offrire recensioni affidabili, dettagliate e aggiornate sui ristoranti di ogni tipo (dalle osterie di quartiere alle cucine stellate). ForkScore mette al centro la voce dei clienti reali.<br>
                        ...
                        ForkScore non è solo uno spazio per recensire, ma una vera e propria community per chi ama scoprire nuovi sapori: grazie a funzionalità come le liste personalizzate, i percorsi gastronomici e i filtri intelligenti, ogni utente può trovare il locale perfetto per ogni occasione.
                    </p>
                </div>
