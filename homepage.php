...
<body>
    <div id="background">
        ...
        <div class="mt-3 w-75 divBackground">
            ...
            <?php include("./utilsPHP/tabellaRecensioniUtente.php"); ?><br>
            <div class="row">
                <div class="col-6 border border-secondary rounded p-3">
                    <h3>Lascia una nuova recensione</h3><hr>
                    <form action="./script_nuovaRecensione.php" method="post">
                        ...
                        <button type="submit" class="btn btn-outline-success mb-3">Invia</button>
                        <button type="reset" class="btn btn-outline-danger mb-3">Annulla</button><br>
                        <?php
                ...
                <div class="col-6 border border-secondary rounded p-3">
                    <h3>Informazioni ristorante</h3><hr>
                    <form action="./inforistorante.php" method="get">
                        <?php include("./utilsPHP/selectRistoranti.php"); ?> <br>
                        <button type="submit" class="btn btn-outline-success mb-3">Invia</button>
                        <button type="reset" class="btn btn-outline-danger mb-3">Annulla</button><br>
                    </form>
